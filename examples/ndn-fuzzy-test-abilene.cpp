...
main(int argc, char* argv[])
{
  ...
  ndn::StrategyChoiceHelper::InstallAll("/prefix1", "/localhost/nfd/strategy/fuzzy");
  ndn::StrategyChoiceHelper::InstallAll("/prefix2", "/localhost/nfd/strategy/fuzzy");
  ...
  consumerHelperWarmup2.SetPrefix("/prefix1");
  ...
  consumerHelperWarmup3.SetPrefix("/prefix2");
  ...
  ApplicationContainer consumerWarmup3 = consumerHelperWarmup3.Install(Names::Find<Node>("Houston"));
